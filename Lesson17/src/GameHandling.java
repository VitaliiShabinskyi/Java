...
public class GameHandling {
    ...
    public void handleGame(){
        System.out.println("*** Лотерея 6 из 36 ***\nВыберите действие:\n" +                  // Выводим приглашение пользователю
                "1 - играть\n" +
                "2 - сжульничать\n" +
                "0 - выйти");
        ...
        lottery.generateWinCombination(36);                    // Создаем выигрышную комбинацию. Инициализируем массив с выигрышной комбинацией.
    ...
    public void performGame(Lottery lottery){
        ...
        System.out.println("Количество угаданных цифр: " + res);  // Выводим результат на консоль
